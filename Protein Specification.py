...
def mainproteinspecs(coordinates):
...
def dictpdb():
    ...
    aahp = {"ALA":"P","GLY":"P","THR":"P","SER":"P","ASN":"P","GLN":"P",
             ...
             "TRP":"H","TYR":"H"}
    pdb_2lwz = open("S:\\INFORMATION TECHNOLOGY\\2ND SEM\\molecular structure prediction\\assignment 1\\2lwz.pdb", 'r')  #assignment pdb file can also be taken as user input by giving path of file
...
mainproteinspecs(dictpdb())                                           # main function is called